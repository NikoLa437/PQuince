...
class PharmacistForSelectedTime extends Component {
	render() {
		return (
				...
				<form>
					<div className="control-group">
						<div className="form-group controls mb-0 pb-2">
							...
							<div
								hidden={this.props.pharmacists.length === 0}
							...
							<p hidden={this.props.pharmacists.length === 0} className="mb-4 mt-4 text-uppercase">
								Click on pharmacist to make reservation
							</p>

							<h5 className=" text-center mb-0 mt-5 text-uppercase text-danger" hidden={this.props.pharmacists.length !== 0}>
								Sorry, we couldn't find free pharmacists at desired time. Try changing date and time.
							</h5>
							<div hidden={this.props.pharmacists.length === 0} className="form-row mt-3">
								<div className="form-col">
...
export default PharmacistForSelectedTime;
