...
class StaffProfilPage extends Component {
	state = {
		id: "",
		email: "",
		password: "",
	...
	componentDidMount() {
			...
			Axios.get(BASE_URL + "/api/users/staff", { validateStatus: () => true, headers: { Authorization: getAuthHeader() } })
				.then((res) => {
			...
			.then((res) => {
				...
				if (this.validateForm(userDTO)) {
					if (found === false) {
						...
						Axios.put(BASE_URL + "/api/users/staff", userDTO, {
							validateStatus: () => true,
...
export default StaffProfilPage;
