...
@Embeddable
public class DrugPriceForPharmacyId implements Serializable{
	...
	public DrugPriceForPharmacyId() {}
	
	public DrugPriceForPharmacyId(DrugInstance drugInstance, Pharmacy pharmacy) {
		super();
