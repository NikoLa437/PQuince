--najvise podataka ima za sledece role
-- patient  email : example@example.com password:123
-- sys admin email : admin@example.com  password:123
-- supplier: supplier@example.com password:123
-- pharmacyadmin: pharmacyadmin@example.com password:123
-- dermatologist: example6@example.com password:123
-- pharmacists: exampla11@example.com password:123
...
insert into users (id, active,email, name,password,phone_number,surname, city, country, street, latitude, longitude, version) values ('23793777-52d3-11eb-ae93-0242ac130002',true, 'example2@example.com','Petar','$2a$10$sqes3IpPL4mBgAAmimisyOWj5DlqPRndrJFNFw9zWiJjyNa5ozKS6','0623333','Djuric','grad Novi Sad','Serbia','Futoška ulica',45.249222,19.826699, 1);
...
insert into users (id, active,email, name,password,phone_number,surname, city, country, street, latitude, longitude, version) values ('25345678-52d3-11eb-ae93-0242ac130002',true, 'example8@example.com','Nemanja','$2a$10$sqes3IpPL4mBgAAmimisyOWj5DlqPRndrJFNFw9zWiJjyNa5ozKS6','0600000','Andjelic','grad Novi Sad','Serbia','Futoška ulica',45.249222,19.826699, 1);
insert into users (id, active,email, name,password,phone_number,surname, city, country, street, latitude, longitude, version) values ('12345678-52d3-11eb-ae93-0242ac130002',true, 'examplederm1@example.com','Djura','$2a$10$sqes3IpPL4mBgAAmimisyOWj5DlqPRndrJFNFw9zWiJjyNa5ozKS6','0600000','Peric','grad Novi Sad','Serbia','Futoška ulica',45.249222,19.826699, 1);
insert into users (id, active,email, name,password,phone_number,surname, city, country, street, latitude, longitude, version) values ('14545678-52d3-11eb-ae93-0242ac130002',true, 'examplederm2@example.com','Petar','$2a$10$sqes3IpPL4mBgAAmimisyOWj5DlqPRndrJFNFw9zWiJjyNa5ozKS6','0600000','Maksimovic','grad Novi Sad','Serbia','Futoška ulica',45.249222,19.826699, 1);
insert into users (id, active,email, name,password,phone_number,surname, city, country, street, latitude, longitude, version) values ('16345678-52d3-11eb-ae93-0242ac130002',true, 'examplederm3@example.com','Katarina','$2a$10$sqes3IpPL4mBgAAmimisyOWj5DlqPRndrJFNFw9zWiJjyNa5ozKS6','0600000','Djuric','grad Novi Sad','Serbia','Futoška ulica',45.249222,19.826699, 1);
insert into users (id, active,email, name,password,phone_number,surname, city, country, street, latitude, longitude, version) values ('35345678-52d3-11eb-ae93-0242ac130002',true, 'example555@example.com','Novica','$2a$10$sqes3IpPL4mBgAAmimisyOWj5DlqPRndrJFNFw9zWiJjyNa5ozKS6','0600000','Zdravkovic','grad Novi Sad','Serbia','Futoška ulica',45.249222,19.826699, 1);
--supplier
...
insert into users (id, active,email, name,password,phone_number,surname, city, country, street, latitude, longitude, version) values ('9ba88d47-1a8a-4ae1-b109-af7b56e94788',true, 'pharmacyadmin1@example.com','Djura','$2a$10$Amd0M3ETJ/9hhxh5zJebvOf9Bx33aDyLS2qmCWbIksaHTS1h9DSAy','062433223','Djuric','grad Novi Sad','Serbia','Futoška ulica',45.249222,19.826699, 1);
insert into users (id, active,email, name,password,phone_number,surname, city, country, street, latitude, longitude, version) values ('9ba78d47-1a8a-4ae1-b109-af7b56e94788',true, 'pharmacyadmin2@example.com','Milan','$2a$10$Amd0M3ETJ/9hhxh5zJebvOf9Bx33aDyLS2qmCWbIksaHTS1h9DSAy','0624943342','Milanovic','grad Novi Sad','Serbia','Futoška ulica',45.249222,19.826699, 1);
--sys admin
...
insert into users (id, active,email, name,password,phone_number,surname, city, country, street, latitude, longitude, version) values ('88885278-52d3-13eb-ae93-0242ac130002',true, 'exampla41@example.com','Predoje','$2a$10$sqes3IpPL4mBgAAmimisyOWj5DlqPRndrJFNFw9zWiJjyNa5ozKS6','0600000','Dikic','grad Novi Sad','Serbia','Futoška ulica',45.249222,19.826699, 1);
...
insert into patient (id, penalty, points) values ('23793777-52d3-11eb-ae93-0242ac130002',0,0);
...
insert into user_authority (user_id, authority_id) values ('23793777-52d3-11eb-ae93-0242ac130002', '7852aa5e-7040-4d99-8255-537a0b226c75');
--dermatologist
...
insert into user_authority (user_id, authority_id) values ('12345678-52d3-11eb-ae93-0242ac130002', '09af8857-2f78-4eec-970f-059d3ed4589f');
insert into user_authority (user_id, authority_id) values ('14545678-52d3-11eb-ae93-0242ac130002', '09af8857-2f78-4eec-970f-059d3ed4589f');
insert into user_authority (user_id, authority_id) values ('16345678-52d3-11eb-ae93-0242ac130002', '09af8857-2f78-4eec-970f-059d3ed4589f');
insert into user_authority (user_id, authority_id) values ('35345678-52d3-11eb-ae93-0242ac130002', '09af8857-2f78-4eec-970f-059d3ed4589f');
--supplier
...
insert into user_authority (user_id, authority_id) values ('9ba88d47-1a8a-4ae1-b109-af7b56e94788', 'ea16767c-2c1f-49fb-ac98-c7739c0036e8');
insert into user_authority (user_id, authority_id) values ('9ba78d47-1a8a-4ae1-b109-af7b56e94788', 'ea16767c-2c1f-49fb-ac98-c7739c0036e8');
--sysAdmin
...
insert into user_authority (user_id, authority_id) values ('25345278-52d3-12eb-ac93-0242ac130002', 'a1e3bac1-6093-4705-b835-eed75c3e5f21');
insert into user_authority (user_id, authority_id) values ('25345278-52d3-13eb-ae93-0242ac130002', 'a1e3bac1-6093-4705-b835-eed75c3e5f21');
insert into user_authority (user_id, authority_id) values ('88885278-52d3-13eb-ae93-0242ac130002', 'a1e3bac1-6093-4705-b835-eed75c3e5f21');
...
insert into patient_allergen (patient_id, allergen_id) values('23793162-52d3-11eb-ae93-0242ac130002','7512234e-c9f9-44bd-94be-4f49c32a342e');
insert into patient_allergen (patient_id, allergen_id) values('23793162-52d3-11eb-ae93-0242ac130002','e4406e24-58c6-11eb-ae93-0242ac130002');
insert into patient_allergen (patient_id, allergen_id) values ('22793162-52d3-11eb-ae93-0242ac130002','062d319f-f393-464c-98fb-b3db29e77626');

--pharmacy
insert into pharmacy (id, name, description, city, country, street, latitude, longitude, consultation_price,version) values ('cafeddee-56cb-11eb-ae93-0242ac130002', 'Benu', 'Benu apoteka','grad Novi Sad','Serbia','Ulica Novosadskog sajma',45.254488,19.827929, 450,1);
insert into pharmacy (id, name, description, city, country, street, latitude, longitude, consultation_price,version) values ('cafeddee-56cb-11eb-ae93-0242ac111002', 'Ivancic i sinovi', 'Ivancic i sinovi','grad Novi Sad','Serbia','Futoška ulica',45.249222,19.826699, 729,1);
insert into pharmacy (id, name, description, city, country, street, latitude, longitude, consultation_price,version) values ('cafeddee-56cb-11eb-ae93-0242ac130202', 'Zdravlje', 'Zdravlje apoteka','gradska opština Zemun','Serbia','Šilerova ulica',44.845752,20.387903, 400,1);
insert into pharmacy (id, name, description, city, country, street, latitude, longitude, consultation_price,version) values ('cafeddee-56cb-11eb-ae93-0242ac131302', 'Kopriva', 'Kopriva apoteka','grad Novi Sad','Serbia','Ulica Novosadskog sajma',45.254488,19.827929, 650,1);
...
insert into staff (id, staff_type) values ('12345678-52d3-11eb-ae93-0242ac130002','DERMATOLOGIST');
insert into staff (id, staff_type) values ('14545678-52d3-11eb-ae93-0242ac130002','DERMATOLOGIST');
insert into staff (id, staff_type) values ('16345678-52d3-11eb-ae93-0242ac130002','DERMATOLOGIST');
insert into staff (id, staff_type) values ('35345678-52d3-11eb-ae93-0242ac130002','DERMATOLOGIST');
...
insert into staff (id, staff_type) values ('9ba88d47-1a8a-4ae1-b109-af7b56e94788','PHARMACYADMIN');
insert into staff (id, staff_type) values ('9ba78d47-1a8a-4ae1-b109-af7b56e94788','PHARMACYADMIN');
--staff-systemAdmin
...
insert into staff (id, staff_type) values ('88885278-52d3-13eb-ae93-0242ac130002','PHARMACIST');
--dermatologist
...
insert into dermatologist (id) values ('14545678-52d3-11eb-ae93-0242ac130002');
insert into dermatologist (id) values ('16345678-52d3-11eb-ae93-0242ac130002');
insert into dermatologist (id) values ('35345678-52d3-11eb-ae93-0242ac130002');
--pharmacist
...
insert into pharmacist (id, pharmacy_id) values ('88885278-52d3-13eb-ae93-0242ac130002','cafeddee-56cb-11eb-ae93-0242ac130202');

--dermatologist-pharmacy
...
insert into pharmacy_admin (id,pharmacy_id) values ('9ba78d47-1a8a-4ae1-b109-af7b56e94788','cafeddee-56cb-11eb-ae93-0242ac130202');
...
----
insert into drug_reservation(id, amount, drug_peace_price, end_date, reservation_status, start_date, drug_instance_id, patient_id, pharmacy_id, version) values ('f96fe75e-59a5-11eb-ae93-0242ac130002', 3, 340, '2021-01-18 17:04:03',  'PROCESSED', '2021-01-16 17:04:03', 'dac2b818-5838-11eb-ae93-0242ac130002', '22793162-52d3-11eb-ae93-0242ac130002','cafeddee-56cb-11eb-ae93-0242ac130002', 2);
insert into drug_reservation(id, amount, drug_peace_price, end_date, reservation_status, start_date, drug_instance_id, patient_id, pharmacy_id, version) values ('f46fe75e-59a5-11eb-ae93-0242ac130002', 5, 340, '2021-02-18 17:04:03',  'ACTIVE', '2021-01-16 17:04:03', 'dac2b818-5838-11eb-ae93-0242ac130002', '22793162-52d3-11eb-ae93-0242ac130002','cafeddee-56cb-11eb-ae93-0242ac130002', 1);

insert into drug_reservation(id, amount, drug_peace_price, end_date, reservation_status, start_date, drug_instance_id, patient_id, pharmacy_id, version) values ('f46fe75e-59a5-11eb-ae93-1111ac130002', 5, 340, '2021-01-18 17:04:03',  'PROCESSED', '2021-01-12 17:04:03', 'dac2b818-5838-11eb-ae93-0242ac130002', '22793162-52d3-11eb-ae93-0242ac130002','cafeddee-56cb-11eb-ae93-0242ac130002', 1);
insert into drug_reservation(id, amount, drug_peace_price, end_date, reservation_status, start_date, drug_instance_id, patient_id, pharmacy_id, version) values ('f46fe75e-59a5-11eb-ae93-2222ac130002', 5, 340, '2021-02-20 17:04:03',  'ACTIVE', '2021-02-06 17:04:03', 'dac2b818-5838-11eb-ae93-0242ac130002', '22793162-52d3-11eb-ae93-0242ac130002','cafeddee-56cb-11eb-ae93-0242ac130002', 1);
insert into drug_reservation(id, amount, drug_peace_price, end_date, reservation_status, start_date, drug_instance_id, patient_id, pharmacy_id, version) values ('f46fe75e-59a5-11eb-ae93-3333ac130002', 5, 340, '2021-01-28 17:04:03',  'PROCESSED', '2021-01-13 17:04:03', 'b4abdfc6-68cb-11eb-a102-d7374f9803ba', '22793162-52d3-11eb-ae93-0242ac130002','cafeddee-56cb-11eb-ae93-0242ac130002', 1);
insert into drug_reservation(id, amount, drug_peace_price, end_date, reservation_status, start_date, drug_instance_id, patient_id, pharmacy_id, version) values ('f46fe75e-59a5-11eb-ae93-5555ac130002', 5, 340, '2021-01-28 17:04:03',  'PROCESSED', '2021-01-14 17:04:03', 'b4abdfc6-68cb-11eb-a102-d7374f9803ba', '22793162-52d3-11eb-ae93-0242ac130002','cafeddee-56cb-11eb-ae93-0242ac130002', 1);
insert into drug_reservation(id, amount, drug_peace_price, end_date, reservation_status, start_date, drug_instance_id, patient_id, pharmacy_id, version) values ('f46fe75e-59a5-11eb-ae93-7777ac130002', 5, 340, '2021-01-28 17:04:03',  'PROCESSED', '2021-01-14 17:04:03', 'b4abdfc6-68cb-11eb-a102-d7374f9803ba', '22793162-52d3-11eb-ae93-0242ac130002','cafeddee-56cb-11eb-ae93-0242ac130002', 1);
insert into drug_reservation(id, amount, drug_peace_price, end_date, reservation_status, start_date, drug_instance_id, patient_id, pharmacy_id, version) values ('f46fe75e-59a5-11eb-ae93-8888ac130002', 5, 340, '2021-02-28 17:04:03',  'ACTIVE', '2021-01-16 17:04:03', 'dac2b818-5838-11eb-ae93-0242ac130002', '22793162-52d3-11eb-ae93-0242ac130002','cafeddee-56cb-11eb-ae93-0242ac130002', 1);
...
insert into work_time (id, start_date, start_time, end_date, end_time, staff_id, pharmacy_id) values ('2fb45518-60d4-11eb-ae93-0242ac130002', '2021-03-20', 8, '2021-04-20', 17, '22345678-52d3-11eb-ae93-0242ac130002','cafeddee-56cb-11eb-ae93-0242ac130002');
...
insert into orders (id, date, type, pharmacy_id, pharmacy_admin_id) values ('44442222-67ac-11eb-ae93-0242ac130002', '2021-01-05' , 'CREATED' , 'cafeddee-56cb-11eb-ae93-0242ac130002' , '9ba98d47-1a8a-4ae1-b109-af7b56e94788');
...
insert into drug_order (id, amount, drug_instance_id) values ('12e34092-67ad-11eb-ae93-0242ac130002', 2, 'aecf0eac-68cb-11eb-9f52-838764dae934' );
insert into drug_order (id, amount, drug_instance_id) values ('12e45092-67ad-11eb-ae93-0242ac130002', 3, 'aecf0eac-68cb-11eb-9f52-838764dae934' );
...
insert into order_drug_for_order (order_id, drug_order_id) values ('44442222-67ac-11eb-ae93-0242ac130002', '12e34092-67ad-11eb-ae93-0242ac130002');
insert into order_drug_for_order (order_id, drug_order_id) values ('44442222-67ac-11eb-ae93-0242ac130002', '12e45092-67ad-11eb-ae93-0242ac130002');
...
insert into offers (id, date_to_delivery, status, price, supplier_id) values ('52331111-67ac-11eb-ae93-0242ac130002', '2021-01-01', 'WAITING', 8300 ,'66666d47-1a8a-4ae1-b109-af7b56e94788');
insert into offers (id, date_to_delivery, status, price, supplier_id) values ('55321111-67ac-11eb-ae93-0242ac130002', '2021-01-01', 'WAITING', 9300 ,'55555d47-1a8a-4ae1-b109-af7b56e94788');
...
insert into offers_for_order (order_id, offers_id) values ('44442222-67ac-11eb-ae93-0242ac130002', '52331111-67ac-11eb-ae93-0242ac130002');
insert into offers_for_order (order_id, offers_id) values ('44442222-67ac-11eb-ae93-0242ac130002', '55321111-67ac-11eb-ae93-0242ac130002');
